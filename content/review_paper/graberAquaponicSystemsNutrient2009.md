...
### Opinion
> [!tip] Opinion
>Explains method in detail (Hydroponics vs Aquaponics) but does not compare tomato experiment with the same criteria (number of days). Also presents results in absolute numbers and not by productivity (compared to m²) which may lead to wrong conclusions. Some of the calculations seem wrong (units of measure). Some of the references are not findable (High-school thesis in german)
>
...
No controlled environment. Two sets of fish with 2.5 m3 fish tank. All fish were fed pellets with 45% of protein content. Does not explain experiment adequately. Hard to know how it was set up, I assume the tomatoes and cucumbers were each in a row of aquaponics but with the same Perch. 

| Plant | Fish | Duration (day) | Hydroponic | Aquaponic | Unit of Measure | Fish Feed (kg/day) | Fish production (kg Fresh Weight) |
| :--- | :--- | :--- | :--- | :--- | :--- | ---- | ---- |
| Aubergine | Tilapia | 105 | 82 | 90 | gFW/m²d | 1.58 | 88 |
| Tomato | Perch | 43H - 67A | 389 | 355 | gFW/m²d | 0.89 | 27 |
| Cucumber | Perch | 42 | 125 | 80 | gFW/m²d | 0.26 | 4 |
...
```math 
 ...
 FCR_Tilapia_Aubergine = (1.58*105) / 88 
 FCR_Perch_Tomato = (0.89*67)/27
 FCR_Perch_Cucumber = (0.26*42)/4

 Stock_Density_Tilapia = 88 / 2.5 
 Stock_Density_Perch = (27+4) /2.5
```
...
> The highest nutrient removal rates by fruit harvest were achieved during tomato culture. For aubergines, nutrient availability was higher due to 78% higher feeding load, but fruit yield from tomato was 201% higher. Cucumber achieved the lowest recycling rates: feed input was lowest, and fruit yield remained moderate as the culture was started late in the year.
...
%% Import Date: 2024-02-11T12:07:31.969-03:00 %%
